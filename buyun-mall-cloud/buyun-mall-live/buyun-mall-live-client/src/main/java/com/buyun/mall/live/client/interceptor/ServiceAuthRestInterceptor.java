...
import com.buyun.mall.live.client.annotation.IgnoreClientToken;
import com.buyun.mall.live.client.config.ServiceAuthConfig;
import com.buyun.mall.live.client.jwt.ServiceAuthUtil;
...
public class ServiceAuthRestInterceptor extends HandlerInterceptorAdapter {
    private Logger logger = LoggerFactory.getLogger(com.buyun.mall.live.client.interceptor.ServiceAuthRestInterceptor.class);
